    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dias_visita', models.ManyToManyField(to='home.DiasVisita')),
                ('horarios', models.ManyToManyField(to='home.Horario')),
                ('imagens', models.ManyToManyField(to='home.Imagem')),
            ],
        ),
        migrations.CreateModel(
            name='Visitas',
            fields=[
                ...
                ('imovel', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='home.imovei')),
